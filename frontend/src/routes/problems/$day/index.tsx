  ...
  return (
    <>
        ...
        <article className="max-w-6xl mx-auto bg-background-300/80 border-12 border-background-600/90 z-10 p-8 my-8 rounded-2xl text-lg flex flex-col gap-8 font-[Fira_Code] font-medium">
            ...
            <>
              {!problem.part2Answer && (
                <p className="text-gold-100 text-shadow-gold-100 text-shadow-xs">
                  You got the first part correct! You're halfway to getting a
                  golden egg. Complete part two to obtain the full golden egg!
                </p>
              )}
          ...
          {problem.part2 !== "" && (
            <>
              ...
              {problem.part2Answer ? (
                <p className="text-gold-100 text-shadow-gold-100 text-shadow-xs">
                  Both parts of the puzzle are complete! You obtained one golden
                  egg.
                </p>
              ) : (
                <>
      ...
      <div className="relative z-0 pointer-events-none">
        <img
          src="/grass2.svg"
          className="w-full absolute bottom-20 sm:bottom-30 md:bottom-38 lg:bottom-45"
        />
