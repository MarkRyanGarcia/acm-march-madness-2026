...
function ProblemPage() {
  ...
  return (
    <main className="p-8">
      <article className="max-w-6xl mx-auto bg-background-300 border-12 border-background-600 p-8 my-8 rounded-2xl text-lg flex flex-col gap-8 font-[Fira_Code] font-medium">
