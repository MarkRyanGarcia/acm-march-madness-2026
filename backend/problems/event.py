...
PROBLEMS: dict[int, ProblemEntry] = {
    ...
    2: ProblemEntry(
        problem_class=FruitMachine,
        readme_path="problems/_02_fruit_making_machine/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 17, 14, 0, 0),
    ),
    3: ProblemEntry(
        problem_class=RobberyPuzzle,
        readme_path="problems/_03_robbery_puzzle/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 18, 14, 0, 0),
    ),
    4: ProblemEntry(
        problem_class=TheClimb,
