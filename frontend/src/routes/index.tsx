...
function LandingPage() {
  ...
  return (
    <div>
      ...
      <div className="relative z-10 mb-25 sm:mb-70 pointer-events-none">
        <img src="/grass2.svg" className="w-full absolute md:-top-24" />
        <img src="/grass1.svg" className="w-full absolute md:-top-24" />
        <img
          src="/particles.svg"
          className="absolute left-0 right-0 mx-auto top-20 md:top-40 w-full"
        />
        <img
          src="/capybara.svg"
          className="absolute right-10 lg:right-40 top-15 sm:top-20 md:top-10 lg:top-15 w-32 sm:w-50 md:w-80"
        />
        <img
      ...
      <div className="relative bg-grass-100 min-h-300 md:min-h-400 lg:min-h-500 mt-32 sm:-mt-20 lg:mt-20 pt-40 md:pt-60 pb-70 w-full">
        <FAQ />
        <img
          src="/fence.svg"
          className="absolute bottom-1/6 lg:bottom-1/3 w-50 sm:w-70 md:w-100 lg:w-120 pointer-events-none"
        />
        <img
          src="/fence.svg"
          className="absolute bottom-1/6 lg:bottom-1/3 right-0 w-50 sm:w-70 md:w-100 lg:w-120 scale-x-[-1] pointer-events-none"
        />
      </div>
      <Footer />
    </div>
