...
PROBLEMS: dict[int, ProblemEntry] = {
    ...
    1: ProblemEntry(
        ...
        readme_path="problems/_00_math_homework/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 16, 12, 0, 0),
    ),
    2: ProblemEntry(
        problem_class=MathHomework,
        readme_path="problems/_00_math_homework/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 17, 12, 0, 0),
    ),
    3: ProblemEntry(
        problem_class=MathHomework,
        readme_path="problems/_00_math_homework/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 18, 12, 0, 0),
    ),
    4: ProblemEntry(
        problem_class=MathHomework,
        readme_path="problems/_00_math_homework/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 19, 12, 0, 0),
    ),
    5: ProblemEntry(
        problem_class=MathHomework,
        readme_path="problems/_00_math_homework/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 20, 12, 0, 0),
    ),
}
