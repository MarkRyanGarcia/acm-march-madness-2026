...
PROBLEMS: dict[int, ProblemEntry] = {
    ...
    1: ProblemEntry(
        ...
        readme_path="problems/_00_math_homework/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 9, 12, 0, 0),
    ),
    2: ProblemEntry(
        problem_class=MathHomework,
        readme_path="problems/_00_math_homework/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 10, 12, 0, 0),
    ),
    3: ProblemEntry(
        problem_class=MathHomework,
        readme_path="problems/_00_math_homework/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 11, 12, 0, 0),
    ),
    4: ProblemEntry(
        problem_class=MathHomework,
        readme_path="problems/_00_math_homework/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 12, 12, 0, 0),
    ),
    5: ProblemEntry(
        problem_class=MathHomework,
        readme_path="problems/_00_math_homework/README.md",
        points_per_part=100,
        release_time=get_release_time(2026, 3, 13, 12, 0, 0),
    ),
}
